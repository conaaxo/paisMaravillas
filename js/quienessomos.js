...
$(document).ready(function() {
	...
	$(".animales").on("click", function(event){
		...
		animalna = $(this).data("na");
		animalen = $(this).data("en");
		...
		if(animalvideo == undefined)
			...
			if(animalna == undefined)
			$("#mna").hide();
		else
			$("#mna").show();
			
			if(animalen == undefined)
			$("#men").hide();
		else
			$("#men").show();
		...
		$("#mna").off("click");
		$("#mna").on("click", function(event){
			event.preventDefault();
			window.open(animalna);
			});
