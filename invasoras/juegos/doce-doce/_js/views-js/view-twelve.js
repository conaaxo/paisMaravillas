window.TwelveApp.ViewTwelve = (function ViewTwelve() {
    ...
    function showWinUI( messageData, counterToReset, bgPicture ) {
        ...
        setTimeout( function() {
            if( counterToReset !== undefined ) { twelveCardsGameCounters[ counterToReset ] = 0; };
