    ...
    function gameUpdateResults( messageDetails, gameState ) {
        ...
        switch( true ) {
            ...
            case gameWinsPlayerOne === gameLimitRounds:
                gameShowResults( { mainMessage: '',subMessage: playerName + ' ganaste ' + gameLimitRounds + ' partidas', result: 'win' } );
                break;

            case gameWinsPlayerTwo === gameLimitRounds:
                gameShowResults( { mainMessage: '', subMessage: 'Invasorín ha ganado ' + gameLimitRounds + ' partidas',result: 'lose' } );
                break;
    ...
    function gamePTwoShowDeciding() {
        ...
        setTimeout( function() {
            if( playerTwoAction ) {
                ...
                dataUI = {  action: 'ha decidido adivinar personaje', question: '¿Tu personaje es ' + guessPlayerTwoCurrentQuestion.article + ' ' + guessPlayerTwoCurrentQuestion.name + '?' };
            }
