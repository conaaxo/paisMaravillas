$(document).ready(function() {
  ...
  ligas = [
    ...
    ['alaselvaseca', 'chaparritayconsentida(selvaseca)', 'chaparritayconcentida', 'chaparritayconcentida', 'Z7ibgNEtn-c', ''],
    ['alasmontanas', 'palaciodeinvierno(bosque)', 'unpalaciodeinvierno', 'unpalaciodeinvierno', 'tvbUGUgdJd8', 'bosque'],
    ...
    ['alaselvahumeda', 'escandalodelavida(selvahumeda)', 'escandalodevida', 'escandalodevida', 'p3_Ijl4tgp0', 'selvahumeda'],
